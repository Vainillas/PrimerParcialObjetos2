...
public class RegistroPagoEnBaseDeDatos implements RegistroDePago {
	private Connection conn;

	public void registrar(String registro) {
		try {
			conn = ConnectionManager.getConnection();
			PreparedStatement statement = conn.prepareStatement("INSERT INTO registro_pagos(data) " + "VALUES (?)");
